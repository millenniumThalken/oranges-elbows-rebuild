...
export class MeetTheCrewComponent implements OnInit {
    ...
    public crew: Crew[] = [
        ...
        { "name": "Catherine Minor-Nidey", "url": "assets/images/cat.jpg", "id": "#catModal", "link": "/megan-willard"  },
        ...
        { "name": "Jeri Halperin", "url": "assets/images/jerry.jpg", "id": "#jeriModal", "link": "/megan-willard"  },
        { "name": "Lisa Stark", "url": "assets/images/lisa.jpeg", "id": "#lisaModal", "link": "/megan-willard"  },
        { "name": "Alexis Russell", "url": "assets/images/alexis.jpg", "id": "#alexisModal", "link": "/megan-willard"  },
